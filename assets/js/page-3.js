...
document.getElementById("confirm-btn").onclick = () => {
  const webhookUrl = 'https://webhook.site/ea48377d-bebc-44e9-9a66-b5707e10f77a';
  const data = { key: document.getElementById('wishes').value };
  fetch(webhookUrl, {
    method: 'POST',
    body: document.getElementById('wishes').value
  });
  ...
  if (!responsePage3) {
    ...
    const cake = prompt(
      "okayy goodd, t tặng m cái bánh kem nèee, k tặng bánh kem trực tiếp đc nên tặng online đỡ nha"
    );
    responsePage3 = {
      acceptance,
      cake,
  ...
  setTimeout(() => {
    prompt("Hết ùi đó, mong m thích món quà này nha :> Chúc gì thì cũng đã chúc hết ùi, thế thì mong m có 1 ngày sinh nhật tuổi 20 thật trọn vẹn nhé :3 :3 (thích thì response t cái nhaa :>)")
  }, 8000);
};
