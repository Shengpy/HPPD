      ...
      setTimeout(() => {
        ...
        if (!responseEndPage2) {
          ...
          const wishPage2 = prompt(
            "Mong là những lời chúc của t sẽ trở thành hiện thực, bởi vì m xứng đáng với những điều tốt đẹp nhất của cuộc đời :> "
          );
          responseEndPage2 = {
            likePage2,
            wishPage2
...
(() => {
  ...
  if (!responseStartPage2) {
    const nextPage2 = prompt(
      "Tiếp đến là những lời chúc của t, cũng như là những tấm hình tuyệt zời của m💓. Mong rằng m sẽ thích :>"
    );
